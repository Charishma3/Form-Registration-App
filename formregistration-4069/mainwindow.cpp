...
{
    QMessageBox::information(this,"Charishma 212218104069","Submitted successfully!!");
}
...
void MainWindow::on_lineEdit_6_returnPressed()
{
    if(ui->lineEdit_6->text().length()>20)
           QMessageBox::information(this,"Charishma 212218104069","size was exceeded!");
}
...
void MainWindow::on_lineEdit_3_returnPressed()
{
    ...
    if (!hasMatch)
    {
       QMessageBox::information(this,"Charishma 212218104069","Invalid Format");
    }
}
